...
## 😄 NEW: Send Emoji to a 16×16 Matrix

This version also lets you **pick an emoji in the web app** and send it to the micro:bit.
The app converts the emoji into a **16×16 monochrome bitmap** and sends it over USB serial as:

```
EMOJI:<64-hex>
```

On the micro:bit, the code displays it on an **external 16×16 NeoPixel (WS2812) matrix (256 LEDs)**.

> Hardware note: most 16×16 NeoPixel panels need more power than the micro:bit can provide. Use an external 5V supply.

# Marketing Asset Guide — Bitmoji Lab
...
| `output/en/screenshots/screenshot-sensors-annotated.png` | Emoji panel with "Live from micro:bit" call-out. |
...
| `classroom-poster.html` | A3 poster for classroom wall. "We Make Emoji Light Shows" + 5 steps. |
...
**Where:** Paste into `bitmoji-lab/index.html` or the hosted live-demo
page (`abourdim.github.io/bitmoji-lab`). Nothing else to do.
...
Output: `output/shared/buyers/BitmojiLab-AS-12345-v1.2.0.zip`
...
**Where:**
- Own GitHub repo like `github.com/abourdim/bitmoji-lab-companion`
- Listed in the Etsy description: "MakeCode extension published — search bitmoji-lab-companion"
...
| URL | What buyer sees |
|---|---|
| `#tab=graph` | Emoji panel, ready to Simulate |
| `#main` | Product demo screen |
| `#tab=senses&lang=fr` | Emoji panel in French |

**Where:**
- Etsy description: "→ See the live 3D tab: abourdim.github.io/bitmoji-lab/#tab=board3d"

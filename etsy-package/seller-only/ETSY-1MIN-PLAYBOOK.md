...
**Title (140 chars max):**
```
Bitmoji Lab — BLE Control Panel for Teachers & Kids · Sensors · Servos · Live Graph · 3D Models · No Install · Chrome / Edge
```

**160-char short description:**
```
Browser-based BLE control panel for the BBC micro:bit V2 + LED matrix. Sensors, servos, live graphs, 3D models, and a GamePad — all from Chrome. No install, no account.
```

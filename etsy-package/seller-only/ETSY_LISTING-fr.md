...
Application Bluetooth Web pour BBC micro:bit V2 + Guide Illustré | 8 Onglets, 100+ Emojis, Graphiques en Direct | STEM École | Téléchargement Numérique
...
>
> 🎮 **Bitmoji Lab** transforme votre micro:bit en laboratoire STEM interactif — rien à installer, aucun compte, aucun cloud. Ouvrez-le dans votre navigateur et connectez-vous.
>
...
>
> 🧪 **Essayez maintenant** (mode Simulation, sans micro:bit) : <https://abourdim.github.io/bitmoji-lab/#lang=fr>
>
...
> • 8 onglets : Matrice LED, Capteurs, Paintbrush, Manette, Graphique, Carte 3D, Banc, Paramètres
...
```
Bonjour {{BUYER_FIRST_NAME}} — merci beaucoup d'avoir pris Bitmoji Lab ! 🎮
...
> Bonjour ! Petit suivi — avez-vous réussi à faire fonctionner Bitmoji Lab cette semaine ? Si vous avez rencontré un souci, répondez ici et je le règle. Si tout a bien fonctionné, une note sur l'annonce m'aide à continuer à créer ce genre d'outils. Dans tous les cas, merci pour votre soutien !

...
> 🧪 **Live demo**: <https://abourdim.github.io/bitmoji-lab/>
...
- [ ] **Record the 60-second listing video** following
      ...
      with videos by ~30%.
- [ ] **Create the BITMOJI5 Etsy promo code** (Shop Manager → Marketing
      → Sales & coupons → new code `BITMOJI5`, $5 discount off $9.99,
...
- [ ] **Shoot a real micro:bit photo** for the hero. Current hero
      ...
      emoji library. Good light, plain background, crop square.
...
- [ ] Final sanity check: does the description's "what you get" list
      exactly match what `BitmojiLab-v1.0.0.zip` actually contains?
...
- [ ] Collect the first 5 reviews. Raise price from $9.99 → $14.99
...
- [ ] **Create the BITMOJI5 promo code** (first 10 buyers: $9.99 → $5

...
All Etsy-release assets for **Bitmoji Lab**: the ZIP builder, the
...
Produces `etsy-package/BitmojiLab-v1.0.0.zip` with the app
...
├── BitmojiLab-v1.0.0/         📦 Build staging dir
├── BitmojiLab-v1.0.0.zip      📦 Final buyer ZIP
│

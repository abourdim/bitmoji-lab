...
const I18N = {
  en: { tagline: 'See the live demo in 30s.', role: 'bitmoji-lab · author', contactLabel: 'Say hi' },
  fr: { tagline: 'Chaque capteur, en direct dans le navigateur.', role: 'auteur · bitmoji-lab', contactLabel: 'Contact' },
  ar: { tagline: 'كل حساس، مباشرةً في المتصفح.', role: 'مؤلف · bitmoji-lab', contactLabel: 'للتواصل' },
};
const T = I18N[LANG];

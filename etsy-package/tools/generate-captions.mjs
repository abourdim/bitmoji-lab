...
TEMPLATES_BY_LANG.ar = {
  ...
  maker: {
    ...
    subtitles: [
      ...
      `رسم Canvas API · نماذج Three.js · مصدر makecode.ts مُرفق`,
...
TEMPLATES_BY_LANG.fr = {
  ...
  kid: {
    ...
    subtitles: [
      `Capteurs, paintbrushes, fonctionnalités. Sans install. Sans compte.`,
  ...
  maker: {
    ...
    subtitles: [
      ...
      `Graphique Canvas API · modèles Three.js · source makecode.ts inclus`,
...
TEMPLATES_BY_LANG.en = {
  teacher: {
    ...
    socialCaptions: [
      ...
      `One Etsy download. Zero IT tickets. Thirty students graphing real brightness data.`,
    ],
    pinCaptions: [
  ...
  kid: {
    ...
    subtitles: [
      `Sensors, paintbrushes, 3D models. No install. No account.`,
      `Works offline after the first open.`,
      `Draw on the LEDs. Hear the buzzer. Tilt the 3D model.`,
      `7 emoji categories of things to try. Your parents won't understand most of them.`,
  ...
  maker: {
    ...
    subtitles: [
      ...
      `Canvas API graph · Three.js models · makecode.ts source included`,

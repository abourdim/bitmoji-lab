# Customization checklist — Bitmoji Lab
...
- [ ] `etsy-package/tools/generate-video.mjs` — ffmpeg-based generator
   ...
   `Bitmoji Lab` / `Paint • Glow • Share` substitutions don't fit your design.
...
- [ ] (Optional) `gh api -X POST "repos/abourdim/bitmoji-lab/pages" -f 'source[branch]=main' -f 'source[path]=/'` — enable GitHub Pages so the live demo URL in the listing actually works
